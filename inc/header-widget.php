	...
	protected function render() {
      ...
      <style>
        ...
        @media (max-width: 568px) {
		  ...
		  li .wpml-ls-legacy-dropdown .wpml-ls-item, li ul{
			  width: fit-content;
		  }
      </style>
                  ...
                  <div class="page-links">
                      <ul class="page-menu-items">
                          ...
                          <?php
                                  ...
                                  ?>
                        <li class="nav__spacer nav__title t-menu" style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">|</li>
                        <li><a class="hover-underline-animation" href="https://www.edgeworkspaces.com/">EN</a> / <a class="hover-underline-animation" href="https://www.edgeworkspaces.com/de/">DE</a></li>
                      </ul>
                      ...
                      <div class="secondary-links">
                          <ul>
                              ...
                              <?php
                                      ...
                                      ?>
                                <li ><a class="hover-underline-animation" href="https://www.edgeworkspaces.com/">EN</a><span style="color: white;"> / </span><a class="hover-underline-animation" href="https://www.edgeworkspaces.com/de/">DE</a></li>
      ...
      <script>
          ...
          jQuery(function() {
			  ...
			  const original_logo = document.querySelector(".navbar-brand").innerHTML;
			  let svgLogo = '<svg xmlns="http://www.w3.org/2000/svg" id="Ring" class="brand-logo-second" width="137.413" height="136.925" viewBox="0 0 137.413 136.925" data-arp-injected="true"><path id="Path_95" data-name="Path 95" d="M82.936,0c36.465.819,67.206,32.516,67.206,69.178,0,37.176-31.57,65.882-68.746,65.882-.258,0-.514,0-.77-.005s-.514-.008-.77-.013c-32.225-.816-56.668-25.766-56.668-58.19,0-32.491,24.549-57.03,56.868-57.741-28.081.714-49.194,21.817-49.194,50.067,0,28.7,21.834,50.535,50.534,50.535.224,0,.447,0,.671-.005s.447-.005.67-.011c32.319-.711,59.732-25.7,59.732-58.192C142.468,29.081,115.16.816,82.936,0" transform="translate(-12.729)" fill="#040405"/><path id="Path_96" data-name="Path 96" d="M68.854,4.151a59.642,59.642,0,0,1,58.1,59.622c0,32.491-25.981,55.6-58.3,56.309,28.081-.714,50.626-20.385,50.626-48.636A51.967,51.967,0,0,0,67.314,19.48c-.223,0-.447,0-.67.005s-.447.005-.67.011A59.638,59.638,0,0,0,7.674,79.12c0,32.424,25.876,59.257,58.1,60.073C29.309,138.374,0,108.108,0,71.446A67.315,67.315,0,0,1,67.314,4.132c.259,0,.515,0,.77.005s.514.008.77.014" transform="translate(0 -2.268)" fill="#040405"/></svg>';
			            jQuery(window).scroll(function() {
				
              if (jQuery(this).scrollTop() > 80) {

				document.querySelector(".navbar-brand").innerHTML = svgLogo;
              } else {
				  document.querySelector(".navbar-brand").innerHTML = original_logo;
              };
          });
